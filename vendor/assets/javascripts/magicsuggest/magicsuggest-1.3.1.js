...
(function($)
{
    ...
    var MagicSuggest = function(element, options)
    {
        ...
        var defaults = {
             ...
             */
            noSuggestionText: 'Brak sugestii',
        ...
        var self = {
            ...
            _render: function(el) {
                ...
                if(cfg.hideTrigger === false) {
                    ms.trigger = $('<span/>', {
                        id: 'ms-trigger-' + $('span[id^="ms-trigger"]').length,
                        'class': 'ms-trigger input-group-btn',
                        html: '<button class="btn btn-common" type="button"><span class="caret"></span></button>'
                    });
                ...
                ms.wrapper.append(ms.trigger);
                ms.container.append(ms.wrapper);
